                ...
                <div class="contenedor-busqueda" id="contenedor-busqueda">
                    <div class="mx-auto " style="width:332px">
                        ...
                        <div class="input-group">
                            <input type="search" class="form-control rounded" placeholder="Ingrese codigo del producto " aria-label="Buscar" 
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        ...
                        <table class="table table-bordered border-primary" style="text-align:center">
                            <thead>
                                <tr>
                                    <th colspan="8" scope="col" style="text-align:center">Productos</th> <!-- Encabezado de la tabla -->
                                </tr>
                                <tr>
                                    <th scope="col">seleccionar</th> <!-- Encabezado de la columna -->
                                    <th scope="col">id producto</th><!-- Encabezado de la columna -->
                                    <th scope="col">nombre producto </th> <!-- Encabezado de la columna -->
            ...
            <div class="d-flex justify-content-around">
                <div class="row">
                    ...
                    <table class="table-responsive">                    
                        <tr>
                            <td><a href="../forms/productos/form_registro.php" class="btn btn-primary" id="addButton">Agregar</a></td>
