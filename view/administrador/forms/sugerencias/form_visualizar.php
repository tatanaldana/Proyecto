...
<html>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="../sugerencias.php">Sugerencias</a></li>
    ...
    <div class='row'>
      <div class='col-md-12 table-responsive'>
       ...
       <tr>
        ...
        <tr>
      <td colspan='4'><a href='../sugerencias.php' class='btn btn-primary'>Cerrar</a></td>
      </tr>
      </table>
    </div>
  </div>
