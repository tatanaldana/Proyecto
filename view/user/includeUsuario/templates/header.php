        ...
        <div class="barra">
            ...
            <?php 
                    if (isset($_SESSION['nombre'])){
                        echo 
                        "<a href='/Proyecto/view/user/index.php'><img src='/Proyecto/img/logo.jpg' alt='imagen logo' height='70px' height='70%'></a>
                        ";
                    }else{
                        echo "<a href='/Proyecto/index.php'><img src='/Proyecto/img/logo.jpg' alt='imagen logo' height='70px' height='70%'></a>";
                    }
                ?>
            ...
            <div class="buscar">
                <form action="/Proyecto/includeUsuario/templates/buscar.php" method="POST">
                ...
                <div class="menu">
                    <img src="/Proyecto/img/menu.png" width='35px' height='35px' alt="Menu Hamburguesa">
                </div>
